...
export CP=lib/bcprov-jdk15-137.jar:lib/mina-core-1.1.2.jar:lib/mina-filter-ssl-1.1.2.jar:lib/slf4j-api-1.4.3.jar:$CP
export CP=lib/slf4j-simple-1.4.3.jar:$CP
