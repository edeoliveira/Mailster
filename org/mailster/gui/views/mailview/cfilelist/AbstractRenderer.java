...
public abstract class AbstractRenderer
{
	...
	/**
	 * Paints the visual representation of the given value on the given GC. The actual class of the
	 * value object is determined by the use of the implementing class.
	 * <p>
	 * Implementors need to respect the bounds values that may have been specified. The bounds
	 * values may affect the x and y values for all drawing operations as well as the width and
	 * heights. Implementors may use a <code>Transform</code> to translate the coordinates of all
	 * the drawing operations, otherwise they will need to offset each draw.
	 * </p>
	 * 
	 * @param gc
	 *            GC to paint with
	 ...
	 * 
	 * @param gc
	 *            convenience GC for string and text extents
	 * @param wHint
	 *            given width (or SWT.DEFAULT)
	 * @param hHint
	 *            given height (or SWT.DEFAULT)
	 * @param value
	 *            value to be sized
	 * @return the size
	 */
