...
import org.mailster.gui.glazedlists.ExtendedTableFormat;
...
public class EventTableViewer<E> implements ListEventListener<E> {
    ...
    private ExtendedTableFormat<E> tableFormat;
    ...
    /**
     * Sets all of the properties on a {@link TableItem}.
     */
    private void setupItem(TableItem item, E value, int realIndex) {
        tableFormat.setupItem(item, value, realIndex);
    ...
    private final class VirtualTableHandler implements TableHandler, Listener {
        ...
        public void handleEvent(Event e) {
            try
            {
                ...
                setupItem(item, (E) swtSource.get(index), index);
            }
