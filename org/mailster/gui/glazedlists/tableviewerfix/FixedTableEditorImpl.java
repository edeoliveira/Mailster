 ...
 * @since 3.1
 */
/* package */abstract class FixedTableEditorImpl {
    ...
    private FixedStructuredViewer viewer;

    FixedTableEditorImpl(FixedStructuredViewer viewer) {
        this.viewer = viewer;
     ...
     * @return the viewer
     */
    public FixedStructuredViewer getViewer() {
        return viewer;
    }
    ...
    private void initCellEditorListener() {
        cellEditorListener = new ICellEditorListener() {
            ...
            public void cancelEditor() {
                FixedTableEditorImpl.this.cancelEditing();
            }

            public void applyEditorValue() {
                FixedTableEditorImpl.this.applyEditorValue();
            }
        };
    }
