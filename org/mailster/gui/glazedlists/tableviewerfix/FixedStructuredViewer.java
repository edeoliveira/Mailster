...
public abstract class FixedStructuredViewer extends ContentViewer implements IPostSelectionProvider {
     ...
     */
    protected FixedStructuredViewer() {
        // do nothing
    }
    ...
    protected void hookControl(Control control) {
        ...
        handler.addOpenListener(new IOpenEventListener() {
            public void handleOpen(SelectionEvent e) {
                FixedStructuredViewer.this.handleOpen(e);
            }
        });
    }
